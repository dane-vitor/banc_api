...
class DepositsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deposit" do
    assert_difference('Deposit.count') do
      post deposits_url, params: { deposit: { current_account: @deposit.current_account, deposit: @deposit.deposit } }, as: :json
    end
  ...
  test "should update deposit" do
    patch deposit_url(@deposit), params: { deposit: { current_account: @deposit.current_account, deposit: @deposit.deposit } }, as: :json
    assert_response 200
  end
